...
import { MatColors } from 'src/common/scss/mat-colors';

export const MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
...
@Component({
  selector: 'hare-material-color-picker',
  templateUrl: './material-color-picker.component.html',
  styleUrls: ['./material-color-picker.component.scss'],
  animations: commonAnimations,
  encapsulation: ViewEncapsulation.None,
  providers: [MATERIAL_COLOR_PICKER_VALUE_ACCESSOR],
...
export class MaterialColorPickerComponent implements ControlValueAccessor {
  ...
  set color(value) {
    ...
    // Split the color value (red-400, blue-500, navy-700 etc.)
